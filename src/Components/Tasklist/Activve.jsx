...
const Active = ({data}) => {
  ...
  console.warn("mera bahi",{data})
  const toggleAuthor = () => {
    setShowAuthor(!showAuthor);
  };

  return (
    <div className="w-[360px] md:w-[430px] h-[300px] md:h-[300px] rounded-2xl shadow-xl text-white p-5 bg-gradient-to-br from-green-500 via-emerald-600 to-green-700 relative overflow-hidden transition-all duration-500 group hover:scale-105">
