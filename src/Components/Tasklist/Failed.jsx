...
const Failed = ({data}) => {
  ...
  return (
    <div className="w-[360px] md:w-[430px] h-[300px] md:h-[300px] rounded-2xl shadow-xl text-white p-5 bg-gradient-to-br from-violet-500 via-red-600 to-red-700 relative overflow-hidden transition-all duration-500 group hover:scale-105">
      ...
      <div className="flex flex-col justify-start h-full mt-10">
        <div>
          ...
          <p className="text-sm md:text-xs text-white/90 mb-4">
{data.desc}        
  </p>
        </div>
