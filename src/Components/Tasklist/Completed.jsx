...
const  Completed= ({data}) => {
  ...
  return (
    <div className="w-[360px] md:w-[430px] h-[300px] md:h-[300px] rounded-2xl shadow-xl text-white p-5 bg-gradient-to-br from-pink-500 via-blue-600 to-red-700 relative overflow-hidden transition-all duration-500 group hover:scale-105">
     ...
     {data.date}
      ...
      <div className="flex flex-col justify-start h-full mt-10">
        <div>
          ...
          <p className="text-[1px] w-full md:text-sm text-white/90 mb-4">
{data.desc}
          </p>
        </div>
